...
`+JSON.stringify(o,null,2):l=" "+this.formatData(o));let m="";if(n){let{sessionId:E,memorySessionId:T,correlationId:O,..._}=n;Object.keys(_).length>0&&(m=` {${Object.entries(_).map(([h,I])=>`${h}=${I}`).join(", ")}}`)}let g=`[${i}] [${d}] [${a}] ${p}${s}${m}${l}`;if(this.logFilePath)try{(0,R.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",m={...s,location:l};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},u=new G;var Nt={};function It(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,de.fileURLToPath)(Nt.url))}var Bt=It(),N=C.get("CLAUDE_PILOT_DATA_DIR"),D=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,ae.homedir)(),".claude"),Gt=(0,b.join)(N,"archives"),Yt=(0,b.join)(N,"logs"),Vt=(0,b.join)(N,"trash"),qt=(0,b.join)(N,"backups"),Kt=(0,b.join)(N,"modes"),Jt=(0,b.join)(N,"settings.json"),ce=(0,b.join)(N,"pilot-memory.db"),zt=(0,b.join)(N,"vector-db"),Qt=(0,b.join)(D,"settings.json"),Zt=(0,b.join)(D,"commands"),es=(0,b.join)(D,"CLAUDE.md"),ts=(0,b.join)(D,".credentials.json"),yt=(0,b.join)(D,"plugins"),ss=(0,b.join)(yt,"marketplaces","pilot");function pe(r){(0,P.mkdirSync)(r,{recursive:!0})}var $=class{db;constructor(e=ce){e!==":memory:"&&pe(N),this.db=new le.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.ensureSessionPlansTable(),this.createProjectRootsTable(),this.ensureNotificationsTable()}initializeSchema(){this.db.run(`
